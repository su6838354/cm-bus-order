...
var add = function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(ctx, next) {var params, activity_id, user_name, cer_type, cer_id, sex, birth, mobile, e_contact, e_contact_mobile, exit_sql, exit_data, sql, data;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            ...
            console.log('insert insurance', sql);_context.next = 15;return (
              (0, _db_connection.query)(sql));case 15:data = _context.sent;
            console.log('insert hw_insurance:', data);
            ctx.body = { code: 0, message: '保单填写成功', data: data };case 18:case 'end':return _context.stop();}}}, _callee, undefined);}));return function add(_x, _x2) {return _ref.apply(this, arguments);};}();
...
/**
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  * @param {*} next
                                                                                                                                                                                                                  */
var list_search = function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(ctx, next) {var params, admin_id, activity_id, user_name, mobile, limit, pageIndex, where, where_sql, first, item, value, activities, sql, data, count;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
            params = ctx.request.body;
            admin_id = params.admin_id, activity_id = params.activity_id, user_name = params.user_name, mobile = params.mobile, limit = params.limit, pageIndex = params.pageIndex;
            where = {};
            // if (activity_id) {
            ...
            activities = [];if (!(
            admin_id && admin_id != 0)) {_context2.next = 18;break;}_context2.next = 12;return (
              (0, _db_connection.query)('select id from hw_activity where admin_id=' + admin_id));case 12:activities = _context2.sent;
