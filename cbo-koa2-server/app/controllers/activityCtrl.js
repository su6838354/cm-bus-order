...
var list = function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(ctx, next) {var params, admin_id, limit, pageIndex, sql, data, count;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            ...
            sql = 'select * from hw_activity where admin_id=? and is_show=1 ORDER BY seq desc limit ?,?';_context.next = 5;return (
              (0, _db_connection.query)(sql, [admin_id, (pageIndex - 1) * limit, limit]));case 5:data = _context.sent;_context.next = 8;return (
              (0, _db_connection.query)('select count(*) as count from hw_activity where admin_id=? and is_show=1', [admin_id]));case 8:count = _context.sent;
...
var list_search = function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(ctx, next) {var params, admin_id, id, title, limit, pageIndex, where, where_sql, first, item, value, sql, data, count;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
            ...
            console.log('list_search_sql:', sql);_context2.next = 14;return (
              ...
              (0, _db_connection.query)('select count(*) as count from hw_activity as A ' + where_sql));case 17:count = _context2.sent;
            // let join_count = await query('select count(*) as count from hw_join where activity_id=?', [data])
            data = data.map(function (item) {
              if (item.registrate_end_time < (0, _moment2.default)().unix()) {
                item.status = 'time_out';
...
/***
                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                         */
var update_show = function () {var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(ctx, next) {var params, id, is_show, sql, res;return _regenerator2.default.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
            params = ctx.request.body;
            id = params.id, is_show = params.is_show;
            sql = 'update hw_activity set is_show=\'' + is_show + '\' where id=' + id;
            console.log('update activity sql:', sql);_context6.next = 6;return (
              (0, _db_connection.query)(sql));case 6:res = _context6.sent;
            ctx.body = { code: 0, message: 'success', data: res };case 8:case 'end':return _context6.stop();}}}, _callee6, undefined);}));return function update_show(_x11, _x12) {return _ref6.apply(this, arguments);};}();exports.default =
