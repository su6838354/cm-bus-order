...
var join = function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(ctx, next) {var params, user_name, user_name_alias, sex, mobile, down_payment, activity_id, extra, joinUser, activities, activity, sql, data, update_res;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            ...
            _context.next = 4;return (0, _db_connection.query)('set autocommit=0;');case 4:_context.next = 6;return (
              ...
              (0, _db_connection.query)('select count(*) as count from hw_join where activity_id=? and mobile=? and is_success=1', [activity_id, mobile]));case 9:joinUser = _context.sent;
            ...
            down_payment + '\', \'' + extra + '\', \'' + activity_id + '\', \'' + (0, _uitil.getLinuxTimeStamp)() + '\', 1\n            )';_context.next = 24;return (
...
var list_search = function () {var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(ctx, next) {var params, admin_id, activity_id, user_name, user_name_alias, mobile, limit, pageIndex, where, where_sql, first, item, value, activities, sql, data, _item, ziliao, count;return _regenerator2.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
            ...
            activities = [];if (!(
            admin_id && admin_id != 0)) {_context3.next = 19;break;}_context3.next = 13;return (
              (0, _db_connection.query)('select id from hw_activity where admin_id=' + admin_id));case 13:activities = _context3.sent;
            ...
            data[_item].isZiliao = ziliao.length === 0 ? 0 : 1;_context3.next = 26;break;case 34:_context3.next = 36;return (
              ...
              (0, _db_connection.query)('select count(*) as count from hw_join as A ' + where_sql));case 36:count = _context3.sent;

            ctx.body = (0, _assign2.default)({ code: 0, message: 'success', 'data': data }, (0, _uitil.pagination)(limit, pageIndex, count[0].count));case 38:case 'end':return _context3.stop();}}}, _callee3, undefined);}));return function list_search(_x5, _x6) {return _ref3.apply(this, arguments);};}();
...
/***
                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                  */
var update_success = function () {var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(ctx, next) {var params, id, is_success, sql, res;return _regenerator2.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
            params = ctx.request.body;
            id = params.id, is_success = params.is_success;
            sql = 'update hw_join set is_success=\'' + is_success + '\' where id=' + id;
            console.log('update hw_join sql:', sql);_context4.next = 6;return (
              (0, _db_connection.query)(sql));case 6:res = _context4.sent;
            ctx.body = { code: 0, message: 'success', data: res };case 8:case 'end':return _context4.stop();}}}, _callee4, undefined);}));return function update_success(_x7, _x8) {return _ref4.apply(this, arguments);};}();exports.default =
...

{
  ...
  update_success: update_success };module.exports = exports['default'];
